function calculo_conica_POSPOS(angulo,tau_xy,numeroPontos)
{
//angulo=0;
/*
* Numerico Puro
...
//usamos o TAU XY que por default será um zero.
        ...
        var Quadrado_t1=(1/SIGMA_T_1)*(1/SIGMA_T_1);
...
// no caso isotropico Poupamos calculo e fazemos apenas o estudo polar:
    ...
    var ang=0;
    var passo=((1/2)*Math.PI/numeroPontos);
...
//Fazemos um corte, para ter apenas um quadrante, ou seja discriminamos pelo sinal



  	filtro_calculo_conica_POSPOS(angulo,tau_xy);

// Colocamos as informações no array final 3
