function filtro_calculo_conica_TRACA_OFIBRA(angulo,tau_xy)
{
...
//	alert("pares_pontos_x.length  "+pares_pontos_x.length);
//	alert("pares_pontos_y.length  "+pares_pontos_y.length);
